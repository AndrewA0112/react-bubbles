...
- [ ] Explain what a token is used for.
  A token allows for authentication on the server, letting us also create PrivateRoutes
- [ ] What steps can you take in your web apps to keep your data secure?
  Add authentication steps, like `axiosWithAuth`
- [ ] Describe how web servers work.
  A client makes a HTTP request and the server makes a HTTP response based on that request
